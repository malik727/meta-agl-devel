...
FILES_${PN}-dev += "${INCLUDEDIR}/system_service/*"

SRC_URI = "git://gerrit.automotivelinux.org/gerrit/staging/basesystem.git;protocol=https;subpath=security_hal/;branch=${AGL_BRANCH}"
