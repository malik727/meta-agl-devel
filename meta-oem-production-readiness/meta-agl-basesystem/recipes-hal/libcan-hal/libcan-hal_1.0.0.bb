...
PV = "1.0.0+gitr${SRCPV}"
SRC_URI = "git://gerrit.automotivelinux.org/gerrit/staging/basesystem.git;protocol=https;subpath=hal/can_hal;branch=${AGL_BRANCH}"
...
FILES_${PN} += " \
    ${libdir}/basesystem/lib${HAL_NAME}.so \
"
