...
SRC_URI = "git://gerrit.automotivelinux.org/gerrit/apps/agl-service-windowmanager-2017;protocol=https;branch=sandbox/zheng_wenlong/launcherTest"
SRCREV = "43ff4c2624e34b9cfbc3f13036fa449b5f46e9b0"
PV = "1.0+git${SRCPV}"
S = "${WORKDIR}/git"
